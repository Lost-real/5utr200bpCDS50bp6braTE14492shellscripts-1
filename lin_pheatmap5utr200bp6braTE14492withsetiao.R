...
bmp(file =args$output,width =600*3,height = 750*3,units = "px",res =72*2)
...
annotation_row = data.frame(
  "Conservation_TE"= factor(rep(c("0.7-1.0: 0.991","0.6-0.7: 0.972","0.5-0.6: 0.941","0.4-0.5: 0.922","0.3-0.4: 0.890","0.1-0.3: 0.823"), c(1482,3352,4461,3394,1453,353)))
  )#对行进行注释
rownames(annotation_row) = paste("", 1:14492, sep = "")
ann_colors = list(
"Conservation_TE" = c("0.7-1.0: 0.991"="#FF0000","0.6-0.7: 0.972"="#D28181","0.5-0.6: 0.941"="#B9B9B9","0.4-0.5: 0.922"="#787878","0.3-0.4: 0.890"="#2E2E2E","0.1-0.3: 0.823"="#000000")
	  )#自己调整颜色
