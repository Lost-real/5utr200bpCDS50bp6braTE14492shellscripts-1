#! /usr/bin/env python
#usage:python lin_extract200bp5UTR+200bpCDSdict0928Reverse.py -f1 AT1G01040.1 -f2 Brassreal5UTRmerge -f3 BraCDSmerge > AT1G01040.1.txt
import argparse
...
for i in d.keys():
    if i in chl_fasta01.keys():
        ...
        if i in chl_fasta02.keys():
            ...
            seq01=chl_fasta01[i][0:200]+chl_fasta02[i][0:50]
            print(">"+str(i)+"\n"+"".join(seq01[-1::-1]))
    else:
        continue
